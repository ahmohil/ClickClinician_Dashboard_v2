...
export const utcDate = (dateString) => {
	return moment(dateString).utc().startOf("day").format("YYYY-MM-DD");
};

export const utcDateToTimeZoneDate = (updatedAt, timeZone) => {
	const dateInTimeZone = moment(updatedAt).tz(timeZone);

	return dateInTimeZone.format("DD MMMM, YYYY ");
};
export const formatDateForBooking = (value) => {
